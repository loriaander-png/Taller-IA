...
async function fetchFact() {
    try {
        ...
        factContainer.innerHTML = `
            <div class="error">
                ⚠ Error al cargar el dato curioso: ${error.message}
            </div>
        `;
    } finally {
...
async function fetchBreeds() {
    try {
        ...
        breedsContainer.innerHTML = `
            <div class="error">
                ⚠ Error al cargar las razas: ${error.message}
            </div>
        `;
    } finally {
...
function createBreedCard(breed) {
    ...
    if (breed.weight) {
        infoHTML += `
            <div class="breed-info-item">
                <span class="breed-info-label">⚖ Peso:</span> ${breed.weight}
            </div>
        `;
    }
    ...
    if (breed.coat_length) {
        infoHTML += `
            <div class="breed-info-item">
                <span class="breed-info-label">✂ Pelaje:</span> ${breed.coat_length}
            </div>
        `;
    }
